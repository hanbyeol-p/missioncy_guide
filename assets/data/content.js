...
const TEXT = {
  1: {
    EASY: {
      "1-1": { subtitle: "", levels: {
        1: {  goal: "목표 지점에 도달하기", hint: "캐릭터가 바라보고 있는 방향에서 오른쪽 왼쪽을 구분하세요!" },
      ...
      "1-3": { levels: {
        1: { goal: "고체추진제 4개 장착하기\n코드 10줄 이하로 작성하기 (권장)", hint: "노란색 자리에 서서 빨간 테두리 창을 마주보고 아이템을 장착해야 해요! \n아이템 장착 시 부품명은 문자이기에 “” 또는 ‘’ 를 사용해야 해요" },
        2: { goal: "액체연료 5개 장착하기\n코드 30줄 이하로 작성하기 (권장)", hint: "for문은 여러 번 사용할 수 있어요!" },
        3: { goal: "추가엔진 6개 장착하기\n코드 30줄 이하로 작성하기 (권장)", hint: "추가엔진을 장착할 때, 방향에 유의하세요! \n왼쪽 3개&오른쪽 3개로 나누어 생각해볼까요?" },
      }},
      "1-4": { goal: "로켓 발사하기", hint: "색칠한 공간에 들어가는 타이밍을 잘 노려보아요" }
    },
    NORMAL: {
      "1-1": { levels: {
